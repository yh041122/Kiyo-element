...
import { useId, useDisabledStyle } from "@kiyo-element/hooks";
import { DROPDOWN_CTX_KEY } from "./constants";
import type { TooltipInstance } from "../Tooltip/types";

import { type ButtonInstance, KiyoButton, KiyoButtonGroup } from "../Button";
  ...
  >
    ...
    >
      <kiyo-button-group
        ...
        v-if="splitButton"
      >
        <kiyo-button @click="$emit('click', $event)">
