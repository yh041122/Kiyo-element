...
// 引入样式
import "kiyo-element/dist/style.css";

import App from "./App.vue";
// 全局使用
createApp(App).use(KiyoElement).mount("#app");
```

```vue
<template>
  <kiyo-button>我是 Button</kiyo-button>
</template>
```

**单个导入**

Kiyo-Element 提供了基于 ES Module 的开箱即用的 Tree Shaking 功能。
...
<script>
import { KiyoButton } from "kiyo-element";
export default {
